...
QString complexleaf::ModelID(void) {
  // specify the name of your model here
  return QString( "complexleaf" );
}

// return the number of chemicals your model uses
int complexleaf::NChem(void) { return 3; }

// To be executed after cell division
void complexleaf::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2) {
  // rules to be executed after cell division go here
  // (e.g., cell differentiation rules)
}

void complexleaf::SetCellColor(CellBase *c, QColor *color) { 
...
void complexleaf::CellHouseKeeping(CellBase *c) {
...
void complexleaf::CelltoCellTransport(Wall *w, double *dchem_c1, double *dchem_c2) {
...
void complexleaf::WallDynamics(Wall *w, double *dw1, double *dw2) {
...
void complexleaf::CellDynamics(CellBase *c, double *dchem) { 
...
// 1st order auxin production in boundary cells    	
	if(c->AtBoundaryP()){
	   if(c->Chemical(2) > par->f){
		...
		// dchem[1] += par->pin_prod * c->Chemical(0) - par->pin_breakdown * c->Chemical(1) - SumFluxFromWalls( c, complexleaf::PINflux );
	   }
 ...
 double complexleaf::PINflux(CellBase *this_cell,
...
Q_EXPORT_PLUGIN2(complexleaf, complexleaf)
